...
### _resolve_playlists(target, custom_path="") (line 155)
Resolve playlists from standard or custom paths.

**Default paths:**
- video: `special://videoplaylists/`
- audio: `special://musicplaylists/`
...
### _get_smart_playlist_type(filepath) (line 217)
Parse .xsp file to get type attribute.
...
### _resolve_settings() (line 423)
Return static list of settings shortcuts.

Various `ActivateWindow(XxxSettings)` actions.

---

### _resolve_library(target) (line 456)
Resolve library nodes (genres, years, studios, tags, actors, etc.).
